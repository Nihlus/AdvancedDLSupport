//
//  MixedModeClassWithInheritedInterface.cs
//
//  Author:
...
public abstract class MixedModeClassWithInheritedInterface : NativeLibraryBase, IInheritedMixedModeLibrary
{
    public MixedModeClassWithInheritedInterface(string path, Type interfaceType, ImplementationOptions options)
        : base(path, options)
    {
    }
