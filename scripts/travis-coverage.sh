...
dotnet run --project altcover/altcover.1.6.230/tools/netcoreapp2.0/AltCover/altcover.core.fsproj --configuration ${BuildConfiguration} --\
 -i=AdvancedDLSupport.Tests/bin/${BuildConfiguration}/netcoreapp2.0 -o=instrumented-adl -x=coverage-adl.xml\
 --assemblyExcludeFilter=.+\.Tests --assemblyExcludeFilter=AltCover.+ --assemblyExcludeFilter=Mono\.DllMap.+

dotnet run --project altcover/altcover.1.6.230/tools/netcoreapp2.0/AltCover/altcover.core.fsproj --configuration ${BuildConfiguration} --\
 -i=Mono.DllMap.Tests/bin/${BuildConfiguration}/netcoreapp2.0 -o=instrumented-mdl -x=coverage-mdl.xml\
...
# And run coverage
dotnet run --project altcover/altcover.1.6.230/tools/netcoreapp2.0/AltCover/altcover.core.fsproj --configuration ${BuildConfiguration} --no-build --\
